                        ...
                        <div class="d-flex align-items-center justify-content-end mb-4">
                            <div class="ml-2">
                                ...
                                <select name="sort" id="sort" class="form-select">
                                    ...
                                    <option value="proce_desc" {{($sort=='proce_desc') ? 'selected': ''}}>Price High</option>
                    ...
                    <div class="col-md-4">
                        <div class="card product-card">
                            <div class="product-image position-relative">
                               ...
                               <img class="card-img-top" src="{{asset('uploads/product/small/'.$productImage->image)}}"  > </td>
                                @else
                                 <img class="card-img-top" src="{{asset('img/default-150x150.png')}}"  ></td>
                                ...
                                <div class="product-action">
                                    <a class="btn btn-dark" href="javascript:void(0);" onclick="addCart({{$product->id}})">
...
<script>
    $(document).ready(function() {
        // Initialize range slider with dynamic price range
        rangeSlider = $(".js-range-slider").ionRangeSlider({
            ...
            prefix: "₹",
            onFinish: function () {
                // Apply filters when range is selected
                apply_filters();
            }
        });
        ...
        $('.brand-label').change(function () {
            apply_filters();  // Call the function when any checkbox is checked/unchecked
        });
...
function apply_filters() {
    ...
    console.log("Selected Brands:", brands);  // Debugging log

    // Build the URL with query parameters
    var url = '{{ url()->current() }}?';  // Base URL

    // Add price range and selected brands to the URL
