...
@section('content')
    ...
    <section class=" section-9 pt-4">
                            ...
                            <table class="table" id="cart">
                                ...
                                <tbody>
                                    @foreach ($cartContent as $item)
                                        ...
                                        @else
                                            <img src="{{ asset('img/default-150x150.png') }}"></td>
                                    @endif
                                    <h2>{{ $item->name }}</h2>
                        </div>
                        </td>
        ...
        <div class="col-md-12 d-flex justify-content-center align-items-center">
            <div class="card text-center shadow-lg p-4" style="border: none;">
                <div class="card-body">
                    <i class="fas fa-shopping-cart text-primary" style="font-size: 4rem;"></i> <!-- Font Awesome Icon -->
                    <h4 class="mt-3 text-dark">Your Cart is Empty</h4>
    ...
    <script>
        ...
        function deleteItem(rowId) {
            if (confirm("Are you sure want to delete?")) {
                $.ajax({
                    url: "{{ route('front.deleteItem.from.cart') }}",
                    type: "post",
                    data: {
                        rowId: rowId
                    },
