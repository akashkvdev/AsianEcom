            ...
            <div class="row ">
                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        <a href="javascript:void(0);" onclick="addCart({{$product->id}})" class="btn btn-dark"><i class="fas fa-shopping-cart"></i> &nbsp;ADD TO CART</a>
                    </div>
                </div>
                        ...
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                <a href="{{route('front.product',$product->slug)}}" class="product-img">
                                    ...
                                    {{-- <img class="card-img-top" src="images/product-1.jpg"
                                        alt=""> --}}
