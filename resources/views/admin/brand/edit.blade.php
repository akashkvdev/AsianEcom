...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="" method="post" id="brandEditForm" name="brandEditForm" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{$brand->slug}}" readonly class="form-control"
                                        placeholder="Slug">
